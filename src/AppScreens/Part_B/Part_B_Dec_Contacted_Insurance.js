    ...
    return (
        <View style={[global.parentContainer, {paddingTop: insets.top, paddingBottom: insets.bottom}]}>
            ...
            <View style={{
                ...
                <Text style={{color: "#1c5bd9", width: "80%", fontSize: 18, marginTop: "15%", marginBottom: "15%"}}>Have
                    you contacted the insurance already about financing the legal process?</Text>
                ...
                <TouchableOpacity style={screens.largeBtnContainer}
                                  onPress={() => navigation.navigate("Part_B_End_Insurance_Not_Contacted")}>
