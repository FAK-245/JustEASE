...
const Part_A_Applicant_Info = ({ navigation }) => {
  ...
  const [OtherCostCoverage, setOtherCostCoverage] = useState("");
  //for dialog boxes
  ...
  return (
      <View style={[global.parentContainer, {paddingTop: insets.top, paddingBottom: insets.bottom}]}>
        ...
        <KeyboardAwareScrollView style={{ backgroundColor: "white", flexGrow: 1, width: "100%" }}>
          <Formik
              initialValues={{
                OtherCostCoverage: OtherCostCoverage,
              }}
          ...
          >
            {({
                ...
                <View style={styles.mainView}>
                  ...
                  <Text style={{ paddingLeft: "6%", color: "#1c5bd9", marginTop: "5%" }}>Up to what amount do they cover the cost?</Text>
                  <View style={styles.textinputconatiner}>
                    <TextInput
                        ...
                        value={values.OtherCostCoverage}
                        onChangeText={handleChange("OtherCostCoverage")}
                        onBlur={handleBlur("OtherCostCoverage")}
                    />
                  ...
                  <ButtonBar next={'Part_B_Dec_Applied_Other_Protection'} submit={handleSubmit}/>
                </View>
            )}
          </Formik>
