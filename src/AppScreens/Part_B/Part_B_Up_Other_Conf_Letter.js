...
const Part_B_Up_Other_Conf_Letter = ({ navigation }) => {
              ...
              >
                ...
                >
                  E1-1.1) wage or salary slips from the workspace
                    ...
                    >
                      B-6) Copy of confirmation letter
                    </Text>
                ...
                >
                  ...
                  >
                    ...
                    <TouchableOpacity style={styles.next} onPress={() => navigation.navigate("Part_C_Dec_Maintenance_Claims")}>
                      <View
                          style={{
                            flexDirection: "row",
...
export default Part_B_Up_Other_Conf_Letter;
