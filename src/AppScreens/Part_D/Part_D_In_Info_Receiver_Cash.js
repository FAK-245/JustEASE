...
const signUpSchema = Yup.object({
  ...
  RCFName: Yup.string()
    ...
    .min(0, "Minimum Input")
    .max(30, "Limit Exceed"),
  RCStreet: Yup.string().min(0).required("Required Field").max(30, "Limit Exceed"),
  RCDob: Yup.string()
    .min(0)
    .required("Required Field")
    .max(20, "Limit Exceed"),
  RCRelationship: Yup.string().min(0).required("Required Field").max(20, "Limit Exceed"),
  RCSum: Yup.string().min(0).required("Required Field").max(20, "Limit Exceed"),
});
...
const Part_A_Applicant_Info = ({ navigation }) => {
  ...
  const [RCLName, setRCLName] = useState("");
  const [RCFName, setFName] = useState("");
  const [RCStreet, setRCStreet] = useState("");
  const [RCDob, setRCDob] = useState("");
  const [RCRelationship, setRCRelationship] = useState("");
  const [RCSum, setRCSum] = useState("");
  //for dialog boxes
  ...
  const saveState = (values) => {
    dispatch(modifyResponses({
      "Angehöriger Nummer eins": `${values.RCLName} ${values.RCFName} ${values.RCStreet}`,
      "Geburts datum1": values.RCDob,
      "Verhältnis1": values.RCRelationship,
      "Monatsbetrag1": values.RCSum,
    }));
   };
            ...
            <View style={styles.mainView}>
              ...
              <View style={styles.textinputconatiner}>
                <TextInput
                  ...
                  onChangeText={handleChange("RCLName")}
                  onBlur={handleBlur("RCLName")}
                />
              ...
              <View style={styles.textinputconatiner}>
                <TextInput
                  ...
                  style={styles.txtinput}
                  placeholder="Input your Text in here"
                  value={values.RCFName}
                  onChangeText={handleChange("RCFName")}
                  onBlur={handleBlur("RCFName")}
                />
              ...
              <View style={styles.textinputconatiner}>
                <TextInput
                  ...
                  style={styles.txtinput}
                  placeholder="Input your Text in here"
                  value={values.RCStreet}
                  onChangeText={handleChange("RCStreet")}
                  onBlur={handleBlur("RCStreet")}
                />
              ...
              >
                {touched.RCStreet && errors.RCStreet}
              </Text>
              ...
              <View style={styles.textinputconatiner}>
                <TextInput
                    ...
                    placeholder="Input your Text in here"
                    value={values.RCDob}
                    onChangeText={handleChange("RCDob")}
                    onBlur={handleBlur("RCDob")}
                />
                <TouchableOpacity onPress={() => setDobDialog(true)}>
                  <Ionicons
                      name="information-circle-outline"
              ...
              <View style={styles.textinputconatiner}>
                <TextInput
                    ...
                    style={styles.txtinput}
                    placeholder="Input your Text in here"
                    value={values.RCRelationship}
                    onChangeText={handleChange("RCRelationship")}
                    onBlur={handleBlur("RCRelationship")}
                />
                <TouchableOpacity onPress={() => setDobDialog(true)}>
                  <Ionicons
                      name="information-circle-outline"
              ...
              >
                {touched.RCRelationship && errors.RCRelationship}
              </Text>


              <Text style={{ marginLeft: "6%", color: "#1c5bd9" }}>
                What is the amount in € you pay monthly
              </Text>
              <View style={styles.textinputconatiner}>
                <TextInput
                    placeholderTextColor={"#87CEEB"}
                    ...
                    placeholder="Input your Text in here"
                    value={values.RCSum}
                    onChangeText={handleChange("RCSum")}
                    onBlur={handleBlur("RCSum")}
                />
                <TouchableOpacity onPress={() => setDobDialog(true)}>
                  <Ionicons
                      name="information-circle-outline"
