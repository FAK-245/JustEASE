...
import End_Screen from "../End/End_Screen";
        ...
        <View style={{flex: 1, backgroundColor: "white", paddingBottom: "14.5%"}}>
            <ScrollView style={{flexGrow: 1}}>
                <View style={styles.View1}>
                    ...
                    <Text style={styles.signuptxt}>Social Assistance</Text>
                </View>
                ...
                <View style={styles.FlatView}>
                    ...
                    <View style={{margin: "8%"}}>
                        <Text style={styles.document2}>
                            Since you receive regular payments for subsistence in accordance with the Twelfth Book of
                            the Social Code
                            (social assistance) and just enclosed the complete most recent notice including the
                            calculation form,
                            you do not need to complete Parts E to J unless the court orders you to do so.
                        </Text>
                    </View>
                </View>
                <View
                ...
                >
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate("End_Screen")}
                    >
                        <View
                            style={{
                                flexDirection: "row",
